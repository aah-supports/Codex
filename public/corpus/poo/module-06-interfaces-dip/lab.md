...
La réservation appelle directement une API de paiement. Impossible de tester le cas “paiement refusé” sans dépendre du réseau.

```java
public class Booking {
    public void confirm() {
        new StripeClient().charge(price());
    }
}
```
